namespace Cliente
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Servicios
            // 
            Servicios.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            Servicios.Location = new Point(621, 102);
            Servicios.Name = "Servicios";
            Servicios.Size = new Size(161, 85);
            Servicios.TabIndex = 9;
            Servicios.Text = "¿Cuantos servicios?";
            Servicios.UseVisualStyleBackColor = true;
            Servicios.Click += Servicios_Click;
            // 
            // ServiciosText
            // 
            ServiciosText.BorderStyle = BorderStyle.FixedSingle;
            ServiciosText.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            ServiciosText.Location = new Point(638, 216);
            ServiciosText.Name = "ServiciosText";
            ServiciosText.Size = new Size(119, 38);
            ServiciosText.TabIndex = 10;
            // 
            // Form1
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(949, 691);
            Controls.Add(ServiciosText);
            Controls.Add(Servicios);
